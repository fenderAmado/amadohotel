...
public class freserva {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "idhabitacion", "Numero", "idcliente", "Cliente", "idtrabajador", "Trabajador", "Tipo_Reserva", "Fecha_Ingresa", "Fecha_Salida", "Costo", "Estado"};
        ...
        sSQL = "select r.idreserva,r.idhabitacion,h.numero,r.idcliente,"
                ...
                + "r.costo_alojamiento,r.estado  from reserva r inner join habitacion h on "+
                " r.idhabitacion=h.idhabitacion where r.fecha_reserva like '%" + buscar + "%' order by r.idreserva desc";
