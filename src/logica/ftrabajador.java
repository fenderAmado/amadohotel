...
public class ftrabajador {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "nombre", "Apaterno", "Amaterno", "Doc", "Num documento", "Direccion", "Telefono", "Email", "Sueldo", "Acceso", "Login", "Clave", "Estado"};
        ...
        sSQL = "select p.idpersona,p.nombre,p.amaterno, p.apaterno,  p.tipo_documento,p.num_documento,"
    ...
    public DefaultTableModel login(String login,String password) {
        ...
        sSQL = "select p.idpersona,p.nombre,p.amaterno,p.apaterno,"
                ...
                + "on p.idpersona=t.idpersona where login='"
