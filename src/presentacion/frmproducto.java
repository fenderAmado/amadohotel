...
public class frmproducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setMaximumSize(new java.awt.Dimension(2147483647, 2147483630));
        ...
        cbounidad_medida.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "KG", "UNI", "LT", "MIN", "GLB" }));
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        if (txtnombre.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "debes ingresar un nombre del producto");
